<html>
	...
	<style>
	  ...
	  .float-left
	  {
		...
		<?php
			$output = shell_exec("C:/Users/saketh/Anaconda3/envs/myenv/python.exe Model2predictor.py");
			$quality = explode("\n",$output);
			$dirname = "proj_imgs/0/";
			$count = 0;
			if($opendir = opendir($dirname))
			{
				while(($file = readdir($opendir)) !== FALSE)
				{
					if($file != "." && $file != "..")
					{
						...
						echo "<img src = '$dirname/$file' height = '150' width = '150'>";
						echo "<h3>  ".$quality[2+$count]."</h3>";
						echo "</div>";
						$count = $count + 1;
					}
				}
